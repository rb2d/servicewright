...
namespace Drupal\presence_admin_toolbar\Form;

/**
 * @file
 * Contains \Drupal\presence_admin_toolbar\Form\SettingsForm.
 */
...
class SettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'presence_admin_toolbar_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['presence_admin_toolbar.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('presence_admin_toolbar.settings');
